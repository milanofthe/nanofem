...
shield, \(22775\) tetrahedra and \(23439\) unknowns, and the sweep of 21
frequencies from \(1\) to \(5\) GHz takes \(8.1\) s on eight threads.
...
Reflection stays between \(-13\) and \(-37\) dB over the band and
transmission above \(-0.3\) dB.}
\label{fig:lines}
\end{figure}
